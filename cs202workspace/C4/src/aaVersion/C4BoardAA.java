...
public class C4BoardAA {

	public char[][] board;
	public Scanner input = new Scanner(System.in);
	public int colIndex, rowIndex;
	private int turn;
	private JLabel[][] grid = aaVersion.ConnectFourMainAA.getGrid();
	private ImageIcon adrianIcon = createImageIcon("images/adrian.png");
	private ImageIcon lonzyIcon = createImageIcon("images/lonzy.jpg");
...
//		System.out.println();
		...
		if(board[rowIndex][colIndex] == '*'){
			...
			if(turn == 1){
				grid[colIndex][rowIndex].setIcon(lonzyIcon);
				aaVersion.ConnectFourMainAA.setGrid(grid);
			}
			else{
				grid[colIndex][rowIndex].setIcon(adrianIcon);
				aaVersion.ConnectFourMainAA.setGrid(grid);
			}
		}
